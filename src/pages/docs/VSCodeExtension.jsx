    ...
    return (
        <div className="space-y-12">
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-white">Quickstart (17 seconds)</h2>
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-white">Core Commands</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                        ...
                        <div key={i} className="p-4 bg-obsidian-800/50 rounded-xl border border-dev-border group hover:bg-obsidian-800 transition-colors">
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-white">AI Orchestration (Cursor)</h2>
            ...
            <section className="space-y-6 text-center pt-8">
                <a 
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3 bg-white text-obsidian-900 rounded-xl font-bold hover:scale-105 transition-transform"
                >
