    ...
    return (
        <div className="space-y-12">
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-slate-900 dark:text-white">Enabling MCP</h2>
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-slate-900 dark:text-white">Manual Connection</h2>
  ...
  "mcpServers": {
    "linggen": {
      "url": "http://localhost:8787/mcp/sse"
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-slate-900 dark:text-white">Advanced Tools</h2>
                <table className="w-full text-left text-xs">
                    <thead className="bg-slate-50 dark:bg-obsidian-800/50">
                        <tr>
                            <th className="px-4 py-3 font-bold font-mono text-jade-500 uppercase tracking-widest">Tool</th>
                            <th className="px-4 py-3 font-bold font-mono text-slate-500 dark:text-obsidian-700 uppercase tracking-widest">Action</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-200 dark:divide-dev-border">
                        {[
                            ...
                            <tr key={tool.name} className="hover:bg-slate-50 dark:hover:bg-obsidian-800/30 transition-colors">
                                <td className="px-4 py-3 font-mono text-jade-600">{tool.name}</td>
                                <td className="px-4 py-3 text-slate-600 dark:text-slate-400 italic">{tool.desc}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
