    ...
    return (
        <div className="space-y-12">
            ...
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-slate-900 dark:text-white">What is a Pack?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 bg-slate-50 dark:bg-obsidian-800/50 rounded-2xl border border-slate-200 dark:border-dev-border">
                        <h4 className="font-bold text-slate-900 dark:text-white mb-2 italic">Skills</h4>
                        <p className="text-xs text-slate-600 dark:text-slate-400">Behavioral guidance on "how" to work. Examples: Test-driven development, minimal diffs, atomic commits.</p>
                    </div>
                    <div className="p-6 bg-slate-50 dark:bg-obsidian-800/50 rounded-2xl border border-slate-200 dark:border-dev-border">
                        <h4 className="font-bold text-slate-900 dark:text-white mb-2 italic">Policies</h4>
                        <p className="text-xs text-slate-600 dark:text-slate-400">Hard constraints and guardrails. Examples: Security standards, forbidden libraries, naming conventions.</p>
                    </div>
                </div>
            </section>

            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-display text-slate-900 dark:text-white">Installation</h2>
