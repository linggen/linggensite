...
function Advantage() {
    return (
        <section className="py-24 bg-white dark:bg-obsidian-900" id="why-linggen">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                    <div className="flex">
                        <motion.div 
                            ...
                            className="p-10 bg-slate-50 dark:bg-obsidian-800/30 rounded-3xl border border-slate-200 dark:border-dev-border relative overflow-hidden group flex-1"
                        >
                            <div className="absolute top-0 right-0 p-4 text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-obsidian-700 font-mono">
                                Old Way
                            </div>
                            <h3 className="text-2xl font-bold text-slate-500 dark:text-obsidian-700 mb-6 font-display line-through decoration-slate-400 dark:decoration-obsidian-700">
                                The Context Gap
                            </h3>
                            <p className="text-slate-600 dark:text-obsidian-700 mb-8 font-medium">
                            ...
                            <ul className="space-y-4 mb-10">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 text-slate-600 dark:text-obsidian-700 text-sm">
                                        <span className="text-xs opacity-50 italic">✕</span> {item}
                                    </li>
                                ))}
                            </ul>
                            <div className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-obsidian-700 font-mono italic">
                                AI is guessing
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="flex">
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.5 }}
                            className="p-10 bg-white dark:bg-obsidian-800 rounded-3xl border-2 border-jade-500 shadow-2xl shadow-jade-500/10 relative overflow-hidden flex-1"
                        >
